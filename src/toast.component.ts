  ...
  template: `
        <div class="toast" [ngClass]="[toast.type, toast.theme]">
            ...
            <div *ngIf="toast.title || toast.msg" class="toast-text">
                <span *ngIf="toast.title" class="toast-title" [innerHTML]="(toast.title | maybeAsync) | safeHtml"></span>
                <br *ngIf="toast.title && toast.msg" />
                <span *ngIf="toast.msg" class="toast-msg" [innerHtml]="(toast.msg | maybeAsync) | safeHtml"></span>
            </div>
        </div>`
})
